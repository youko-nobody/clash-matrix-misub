    ...
    */
    {
        ...
        meta: { title: 'Clash Matrix Studio', isPublic: true } // Public, so Entrance.vue can decide what to render
    }
];
...
router.beforeEach(async (to, from, next) => {
    ...
    if (typeof document !== 'undefined') {
        document.title = to.meta.title ? `${to.meta.title} - Clash Matrix Studio` : 'Clash Matrix Studio';
    }
